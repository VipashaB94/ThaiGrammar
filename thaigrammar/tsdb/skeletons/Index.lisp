...
((:path . "testsuite_main") (:content . "Main SVCs"))
((:path . "testsuite_coordination") (:content . "VP Coordination"))
((:path . "testsuite_regression") (:content . "Testsuite Regression"))
((:path . "testsuite_interaction") (:content . "SVC Interactions"))
((:path . "testsuite_directional") (:content . "Directional SVCs"))
((:path . "testsuite_heldout") (:content . "Held Out Sentences"))
